...
<body>
	...
	<table border="1">
		<tr>
			<th>시작일</th>
			<td>
			<input type="text" name="strdate" value="<%= calendar.getStrDate() %>"/>
			</td>
		</tr>
		<tr>
			<th>종료일</th>
			<td>
			<input type="text" name="enddate" value="<%= calendar.getEndDate() %>"/>
			</td>
		</tr>
		<tr>
			<th>일정내용</th>
			<td>
			<input type="text" name="content" value="<%= calendar.getContent() %>"/>
			</td>
		</tr>
	</table>
