...
<body>
	...
	<div>
		<a href="<%= request.getContextPath() %>/users/userslist.jsp">
		닫기
		</a>
		<a href="<%= request.getContextPath() %>/users/update.jsp?no=<%= user.getUno() %>">
		수정
		</a>
		<form action="<%= request.getContextPath() %>/users/delete_pro.jsp" method="post">
