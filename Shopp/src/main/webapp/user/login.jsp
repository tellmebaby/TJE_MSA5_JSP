	  ...
	  <form action="login_pro.jsp" method="post">
	    ...
	    <div class="form-check text-start my-3 d-flex justify-content-around">
	    	<div class="item">
	    	  ...
	    	  %>
			      <input class="form-check-input" type="checkbox" name="rememberId" id="flexCheckDefault1"
			      		 checked>
			  <%
	    	  	} else {
	    	  %>  
	    	...
	    	<div class="item">
		      <input class="form-check-input" type="checkbox" name="rememberMe" id="flexCheckDefault2">
